...
namespace FubuDate.Configuration.Policies
{
    public class EndpointUrlPolicy : IUrlPolicy
    {
        ...
        public IRouteDefinition Build(ActionCall call)
        {
            ...
            routeDefinition.Append(BreakUpCamelCaseWithHypen(call.HandlerType.Name.Replace(ENDPOINT, string.Empty).Replace("Index", string.Empty)));
